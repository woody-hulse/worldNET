...
def main(save=True, load=False, train=True, load_model=False, save_model=True):
    ...
    train_distribution_model(feature_model.feature_distribution_nn, train_grouped_features, train_grouped_labels, test_grouped_features, test_grouped_labels, epochs=16, batch_size=32, downsampling=1, verbose=1, summary=True)
    ...
    print_results([simple_nn_model, mean_model, guess_model, randomized_guess_model, worldNET, feature_model], 
                  [test_images, test_images, test_images, test_images, test_images[:64], test_grouped_features], 
